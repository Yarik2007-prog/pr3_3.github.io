...
// Підставляє імена в шаблон
function formatLog(template, attacker, defender) {
  return template
    .replace(/\[ПЕРСОНАЖ №1\]/g, attacker)
    .replace(/\[ПЕРСОНАЖ №2\]/g, defender);
}

// Додає лог на сторінку (остання дія зверху)
...
// Основна функція: генерує та додає лог бою
function getBattleLog(attacker, defender, damage, defenderHP, defenderMaxHP) {
